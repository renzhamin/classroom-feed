<script lang="ts">
    ...
    import { sel_courses, course_map } from "./store";
...
<aside
    ...
    class="flex flex-col gap-y-2 justify-center items-center md:sticky md:top-[6vh] w-full md:w-[23%] max-h-[94vh] p-4 bg-base-200"
>
